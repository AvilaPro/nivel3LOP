...
SubProceso conclusion(sueldoBase, sueldototal Por Referencia)
	Definir cantidadVenta, comisionVenta, montoSubTotal, comporc como Real
	calcularComisionPorCantidad(cantidadVenta, comisionVenta)
	calcularComisionPorcentual(montoSubTotal, comporc)
...
Algoritmo modularidad4Parametros
	...
	conclusion(sueldoBase, sueldototal)
FinAlgoritmo
