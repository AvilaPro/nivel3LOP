...
SubProceso Determ_Empl_MasJoven(Edad_Emp,Nomb_Emp,MenorEdad Por Referencia,Emp_MasJoven Por Referencia)
	Si Edad_Emp<MenorEdad
		entonces
			MenorEdad=Edad_Emp
			Emp_MasJoven=Nomb_Emp
	FinSi
FinSubProceso
...
Algoritmo Procesar_Empleados
	...
	Repetir
		...
		Determ_Empl_MasJoven(Edad_Emp,Nomb_Emp,MenorEdad,Emp_MasJoven)
